...
export const galleryImagesBySite = {
  1: [ // Site 1 - Industrial Complex (MNO Engineering Works)
    ...
    },
    {
      ...
      duration: '4 weeks',
      teamSize: '2 engineers',
      challenges: 'transformaer installed',
      solutions: '3D modeling software utilization, thermal analysis tools, modular design approach for easy maintenance',
      additionalPhotos: [
        { id: 1, title: '3D Panel Design', description: 'Advanced 3D modeling and visualization' ,imageUrl: getOptimizedImage('transformer2_oqognv'),
        responsiveImages: getResponsiveImages('transformer2_oqognv'),},
        { id: 2, title: 'Thermal Analysis', description: 'Heat dissipation study and cooling system design',imageUrl: getOptimizedImage("transformer_cjz6p4",),
        responsiveImages: getResponsiveImages('transformer_cjz6p4'), },
        { id: 3, title: 'Layout Planning', description: 'Optimal component arrangement and accessibility',imageUrl: getOptimizedImage('trnasformer3_dktjak'),
        responsiveImages: getResponsiveImages('trnasformer3_dktjak'), },
        { id: 4, title: 'Compliance Verification', description: 'Standards compliance and safety verification' ,imageUrl: getOptimizedImage('vsb_xbrx0h'),
        responsiveImages: getResponsiveImages('vsb_xbrx0h'),}
      ]
    }
  ],
